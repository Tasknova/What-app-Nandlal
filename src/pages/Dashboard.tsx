import { MessageSquare, Users, BarChart3, Send, Clock, FileText, HelpCircle, CheckCircle, Wallet, RefreshCw } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const userName = "Nandlal Jewellers";
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-amber-50 to-yellow-100 rounded-lg p-6">
            ...
            <div className="flex items-center gap-4 mb-2">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">
                  Nandlal Jewellers - WhatsApp Business Hub
                </h1>
      ...
      {/* Wallet Balance - Prominent at the top */}
